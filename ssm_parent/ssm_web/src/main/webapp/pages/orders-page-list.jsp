			...
			<section class="content">
									...
									<c:forEach items="${pageInfo.list}" var="orders">
										...
										<tr>
											...
											<td class="text-center">
												...
												<%--<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/pages/orders-show.jsp'">详情</button>--%>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
								<%--点击首页应访问分页查询所有方法,显示的页码是第一页,每页显示的数量是pageInfo中封装的当前页的数据数量--%>
							...
							<li><a href="${pageContext.request.contextPath}/orders/findAll?page=${page}&size=${pageInfo.pageSize}">${page}</a></li>
							</c:forEach>
